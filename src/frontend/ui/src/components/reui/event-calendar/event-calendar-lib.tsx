/* eslint-disable eslint/no-unmodified-loop-condition, oxc/no-map-spread, unicorn/no-array-sort */
import { expandRecurrence } from "@apesdb/ui/components/reui/event-calendar/event-calendar-recurrence";
import type {
  CalendarEvent,
  CalendarView,
