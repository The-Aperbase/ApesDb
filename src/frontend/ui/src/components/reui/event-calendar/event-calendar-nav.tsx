...
import { toZoned } from "@apesdb/ui/components/reui/event-calendar/event-calendar-lib";
import type { CalendarView } from "@apesdb/ui/components/reui/event-calendar/event-calendar-types";
import { mergeProps } from "@base-ui/react/merge-props";
import { useRender } from "@base-ui/react/use-render";
import { addDays, format } from "date-fns";

import { cn } from "@apesdb/ui/lib/utils";
import { Button } from "@apesdb/ui/lib/button";
import { Calendar } from "@apesdb/ui/lib/calendar";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
  ...
  DropdownMenuLabel,
  DropdownMenuTrigger,
} from "@apesdb/ui/lib/dropdown-menu";
import { Popover, PopoverContent, PopoverTrigger } from "@apesdb/ui/lib/popover";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@apesdb/ui/lib/tooltip";
...
function EventCalendarDatePicker({
  ...
  const resolved =
    configured === "auto" ? (RANGE_VIEWS.includes(view) ? "range" : "single") : configured;
